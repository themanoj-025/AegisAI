...
class TestBuildReviewBody:
    ...
    def test_inline_comment_when_not_low_confidence(self):
        findings = [
            {
                "severity": "high",
                "category": "xss",
    ...
    def test_low_confidence_falls_to_summary(self):
        findings = [
            {
                "severity": "low",
                "category": "info",
...
class TestMapHintToLine:
    ...
    def test_matching_hint_returns_line(self):
        diff_files = [
            {
                "filename": "app.py",
...
class TestPostReview:
    ...
    def test_successful_review(self, mock_client_cls):
    ...
    @patch("app.services.github_reviewer.httpx.Client")
    def test_422_fallback_to_summary(self, mock_client_cls):
        mock_422 = MagicMock()
    ...
    @patch("app.services.github_reviewer.httpx.Client")
    def test_api_error_raises_runtime(self, mock_client_cls):
        mock_response = MagicMock()
